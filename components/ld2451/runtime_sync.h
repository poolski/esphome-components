...
inline ReconcileResult reconcile_from_device(const RuntimeConfig &current, RuntimeConfig readback) {
...
inline bool should_run_sync(bool force_sync, bool sync_in_flight, uint32_t now_ms, uint32_t last_sync_ms,
